...
Before processing a transaction using the "Payment Profile", you need to have created a profile (see Create New Profile).

A profile is a "multi-use" token. Please distinguish it from a single-use Legato token (see Legato Tokens).
